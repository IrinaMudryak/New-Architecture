 ...
 */
public class UserEditorPage extends Page{

    public UserEditorPage(PageManager pages){
        super(pages);
    }
    ...
    @FindBy(how = How.XPATH, using = "//div[@class='access_group']/span[contains(text(), 'Settings WebsitePage')]")
    ...
    public UserEditorPage turnOnMapCustomCheckbox() throws InterruptedException {
        toolsItem.click();
    ...
    /*turn on LeadsPage Email checkbox in Access tab(if it is off)*/
    public UserEditorPage turnOnLeadsEmail() throws InterruptedException {
    ...
    /*turn on LeadsPage CRM checkbox in Access tab(if it is off)*/
    public UserEditorPage turnOnLeadsCRM() throws InterruptedException {
    ...
    /*turn on WebsitePage Settings checkbox in Access tab(if it is off)*/
    public UserEditorPage turnOnWebsiteSettings() throws InterruptedException {
        waitUntilElementUsable(settingsWebsiteItem);
         settingsWebsiteItem.click();
      waitForJSandJQueryToLoad();
    ...
    public UserEditorPage turnOnWebmail() throws InterruptedException {
    ...
    public UsersPage addNewManager(){
        loginInput.clear();
    ...
    /*go to Access tab*/
    public UserEditorPage clickAccessTab(){
